...
const User = (function(){
    ...
    const formatResponse = (JsonObject,isSuccess)=>{
        return {
                success: isSuccess,
                data:JsonObject
            }
    ...
    const sendTempPasswordToEmail = async(user_name,email,tempPwd)=>
    {
    ...
    const sendVefificationEmail = async(user_name,email)=>{
...
*/
    const sendTempPassword = async(email)=>
    {
        try
        {
            ...
            sendTempPasswordToEmail(item.user_name,email, data.temp_password.password)
...
*/
    const addUser = async (user)=>{
        ...
        // user.clients = Utility.deepCopy(userEmptyItem.clients,5);
            ...
            sendVefificationEmail(user.user_name, user.email)
    ...
    */
    const updatePayee = async (paramObj)=>{
        try
        {
    ...
    */
    const updateBasics = async (paramObj)=>{
        try
        {
    ...
    */
    ...
    const checkPrimaryKey = async(user_name, email) =>{
    ...
    */
    const changeEmail = async(dataObj) => {
        ...
        try
        {
            ...
            //no need to wait it here
            sendVefificationEmail(dataObj.user_name, dataObj.new_email)
    ...
    */
    const changePassword = async(dataObj)=>{
        ...
        try
        {
            let response = await checkPassword(dataObj.user_name,dataObj.current_password )
    ...
    */
    const addClient = async (paramObj)=>{
        try
        {
    ...
    */
    const updateClient = async (paramObj)=>{
        try
        {
    ...
    */
    const deletePayee =async (whichPayee)=>{
        try
        {
    ...
    */
    const deleteClient =async (whichClient)=>{
        try
        {
    ...
    const getClients = async(userName)=>{
        try
        {
...
return {
    sendTempPasswordToEmail:sendTempPasswordToEmail,
    sendVefificationEmail:sendVefificationEmail,
